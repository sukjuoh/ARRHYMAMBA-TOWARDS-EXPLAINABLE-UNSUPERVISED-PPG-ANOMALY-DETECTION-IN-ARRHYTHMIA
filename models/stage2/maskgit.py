...
from models.stage2.mambarope import MambaTransformer2
from models.stage2.mamba_only import Mambaonly
from models.stage2.transformer_only import TransformerOnly
...
class MaskGIT(nn.Module):
    ...
    def __init__(self,
        ...
        self.stage1 = ExpStage1.load_from_checkpoint(os.path.join('saved_models', 'stage1_final.ckpt'), 
                                                     config=config,
                                                     map_location='cpu')
        freeze(self.stage1)
        self.stage1.eval()
        ...
        # transformer
        self.transformer = MambaTransformer2(embed_dim=config['encoder']['dim'],
